            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1PEEYeGt0SWTz0dMRZgRysm-uHroHmp5O/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Kurasi</h2>
                        <br />
                        <a href="https://drive.google.com/drive/folders/1g-fqmcbOycJpjW9rA-Q_KbWstyuOOU0Y?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
