            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1gtOBTb59KhHgb44XoGp0gTWFVfQumJhk/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Kurasi</h2>
                        <br />
                        <a href="#" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
